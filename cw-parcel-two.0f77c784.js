...
var _calculator = require("./js/calculator"); // Третій варіант. Передає функцію та через calc.(функція)(налаштування функції)    (calc це просто назва, вона може бути будь яка)
// import {add, minus, multiply, divide} from './js/calculator';
// console.log(add(2, 2));
// console.log(minus(2, 2));
// console.log(multiply(2, 2));
// console.log(divide(2, 2));
console.log(_calculator.add(2, 2));
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire7378", {})

//# sourceMappingURL=cw-parcel-two.0f77c784.js.map
